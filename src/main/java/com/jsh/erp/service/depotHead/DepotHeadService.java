...
//                    String materialUnit = diEx.getMaterialUnit();
                    ...
                    stock = depotItemService.getStockByParam(detail.getSId(), materialId, null, null, organId);
...
//            dhd.setFilePath(detail.getFilePath());
    ...
    public void unAssignDelivery(Long headerId, HttpServletRequest request) throws Exception {
        // 是否有此配送單
        DepotHead depotHead = depotHeadMapper.selectByPrimaryKey(headerId);
        if(depotHead == null) {
            throw new BusinessRunTimeException(ExceptionConstants.DEPOT_HEAD_HEADER_ID_NOT_EXIST_CODE,
